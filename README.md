...
{
	"ConnectionStrings": {
		"Master": "Server=localhost;User Id=root;Password=yourpass;",
		"Default": "Server=localhost;Database=mydmsdb;User Id=root;Password=yourpass;"
	},
	"Jwt": {
		"Key": "REPLACE_WITH_LONG_RANDOM_SECRET",
		"Issuer": "DmsIssuer",
		"Audience": "DmsAudience",
		"ExpiryMinutes": 120
	},
	"DBinit": {
		"Admins": [ { "Mobile": "9000000000", "Username": "admin", "Password": "Admin@123" } ],
		"User":   [ { "Mobile": "9111111111", "Username": "user1", "Password": "User@123" } ],
		"Majors": [ { "Name": "Finance", "Minors": ["Invoices", "Reports"] } ]
	}
}
```
&nbsp;
